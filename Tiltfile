...
docker_build_with_restart(
  'golang-ride-sharing/api-gateway',
  '.',
...
docker_build_with_restart(
  'golang-ride-sharing/trip-service',
  '.',
...
docker_build_with_restart(
  'golang-ride-sharing/driver-service',
  '.',
...
if os.name == 'nt':
 trip_compile_cmd = './infra/development/docker/payment-build.bat'
...
docker_build_with_restart(
  'golang-ride-sharing/payment-service',
  '.',
