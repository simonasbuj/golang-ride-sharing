...
type TripDriver struct {
	...
	CarPlateNumber string                 `protobuf:"bytes,4,opt,name=carPlateNumber,proto3" json:"carPlateNumber,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *TripDriver) GetCarPlateNumber() string {
	if x != nil {
		return x.CarPlateNumber
	}
	return ""
}
...
const file_trip_proto_rawDesc = "" +
	...
	"\x06driver\x18\x06 \x01(\v2\x10.trip.TripDriverR\x06driver\"\x80\x01\n" +
	"\n" +
	"TripDriver\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12&\n" +
	"\x0eprofilePicture\x18\x03 \x01(\tR\x0eprofilePicture\x12&\n" +
	"\x0ecarPlateNumber\x18\x04 \x01(\tR\x0ecarPlateNumber2\x92\x01\n" +
	"\vTripService\x12B\n" +
